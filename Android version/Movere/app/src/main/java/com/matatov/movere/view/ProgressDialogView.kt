package com.matatov.movere.view
...
import kotlinx.android.synthetic.main.element_progress_view.view.*
...
class ProgressDialogView {
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        val view = inflater.inflate(R.layout.element_progress_view, null)
        if (title != null) {
